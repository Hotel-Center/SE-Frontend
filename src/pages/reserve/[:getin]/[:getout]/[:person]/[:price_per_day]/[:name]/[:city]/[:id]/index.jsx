...
class Reservation extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      person: window.location.pathname.split("/")[4],
      getin: window.location.pathname.split("/")[2],
      getout: window.location.pathname.split("/")[3],
      im1: null,
      im2: null,
      im3: null,
      im4: null,
      ...
      end_day: "2022-05-23",
      price_per_day: window.location.pathname.split("/")[5],
      images: [],
      name: window.location.pathname.split("/")[6],
      city: window.location.pathname.split("/")[7],
      num_passenger: "10",
  ...
  calculatePrice() {
    let getouturl = window.location.pathname.split("/")[3];
    let getinurl = window.location.pathname.split("/")[2];
    console.log("GETIN: ", getinurl);
    // let s = this.state.getin.split("-")[2];
    let s = getinurl.split("-")[2];
    console.log(s, "pay");

    let e = getouturl.split("-")[2];
    console.log(e, "pay");
  ...
  handleSubmit(e) {
    ...
    console.log("before check validaton");
    if (formvalid2(this.state)) {
      ...
      axios
        .post(
          makeURL(
            references.url_reserveroom + window.location.pathname.split("/")[8]
          ),
          {
            ...
            // room_id: window.location.pathname.split("/")[8],
          },
          {
            headers: {
              ...
              <div className="carousel-inner">
                ...
                {/* <div className="carousel-item">
                  <img
                    ...
                    alt="..."
                  />
                  <Image src={this.state.im2} width={400} height={300} />
                </div> */}
                {/* <div className="carousel-item">
                  <Image src={this.state.im3} width={400} height={300} />
                  <img
                    src={this.state.im3}
                    style={{ borderRadius: "50px" }}
                    className="d-block w-100"
                ...
                {/* <div className="carousel-item">
                  <Image src={this.state.im4} width={400} height={300} />
                  <img
                    src={this.state.im4}
                    style={{ borderRadius: "50px" }}
                    className="d-block w-100"
